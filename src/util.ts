...
export function getProjectPath(): string {
  // const config: string | undefined = vscode.workspace.getConfiguration("task-parser").get("ProjectDir")
  // if (!config) {
  //   throw "Error"
  // }
...
export function getInboxPath(): string {
  // const config: string | undefined = vscode.workspace.getConfiguration("task-parser").get("inboxFile") // || ""
  // if (!config) {
  //   throw "Error"
  // }
  // return config
